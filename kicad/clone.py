...
inputBoard = 'artnet_node.kicad_pcb'
#Output file, original file remains unmodified
outputBoardFile = 'output.kicad_pcb'
...
move_dx = FromMM(50)		#Spacing between clones in x direction
move_dy = FromMM(50)		#Spacing between clones in y direction
